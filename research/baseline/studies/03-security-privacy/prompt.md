...
Act as a product security architect and privacy engineer. Today is July 2026. Build a practical threat model for the UAM replacement using current primary sources and standards. Inspect the attached `code-reference.md`, but never reproduce internal identifiers or potentially sensitive example content unnecessarily.
