...
**Result path:** `batches/02-endpoint-data/review/result-review-02-endpoint-data.md`  
...
|---|---|---|---|
| I01 | `result-07-g2-g3-edge-acquisition-cursor.md` | `d839aa76a7fc73fba7dba02c26635746a5babdc059cd1eeaa36e32a9913ce384` | Edge root/profile discovery, live SQLite acquisition, source/generation continuity, native-ID cursor, synthetic fixtures, failure tests; topic recommendation, not passed runtime evidence |
| I02 | `result-08-g4-url-privacy-transformation.md` | `7f7ecff4b991012fc32e0c15303f97c43409993e4ced2e868e0df4f5f38e08f7` | URL parsing, host matching, privacy transformation, canaries, differential tests; topic recommendation, not field/legal/production authority |
| I03 | `result-review-01-foundations.md` (local attachment `batch-01-review-result(3).md`) | `10d5e1e73fa7e63156ddc942c8f63156d29b7cff238ea7d4e128587b47f4c75b` | accepted predecessor contracts, G1 boundary, privacy lattice, application identity/matcher, repository and evidence gates |
