...
**Result path:** `batches/04-server-platform/16-database-comparison-experiment/result-16-database-comparison-experiment.md`  
...
| I05 | `result-review-01-foundations.md` | `batch-01-review-result(3).md` | `10d5e1e73fa7e63156ddc942c8f63156d29b7cff238ea7d4e128587b47f4c75b` | accepted predecessor contracts, realm rules, modular-monolith boundary, repository/evidence controls, database benchmark gate |
| I06 | `result-review-02-endpoint-data.md` | same | `98aace500e7af551a1b024118ee52935643bd61c45ea9afc5b67c49967c301ef` | accepted endpoint source, identity, interpretation, whole-page, and stable event semantics; not server capacity proof |
| I07 | `result-review-03-durability-release-identity.md` | same | `76854c3d6a12b9b717da90d4e368273bd88a672fc64a315afaeacfb3d701a785` | accepted endpoint durability, receipt, identity, diagnostics, release, and exact-evidence principles; later inbox/capacity/restore gates remain open |
...
| I06 | `result-review-02-endpoint-data.md` | `98aace500e7af551a1b024118ee52935643bd61c45ea9afc5b67c49967c301ef` | stable event identity, minimized page/effect semantics, server-derived realm and G5 handoff | endpoint/source review; no production server workload, retention, query, or database benchmark |
