# Batch 04 reviewer — Server ingestion, database, capacity, and data lifecycle
...
Save the complete response as `batches/04-server-platform/review/result-review-04-server-platform.md`.
...
- `result-15-ingestion-relational-inbox.md`
- `result-16-database-comparison-experiment.md`
- `result-17-capacity-fleet-simulator.md`
- `result-18-retention-deletion-restore.md`
...
Build a contract-accurate endpoint simulator; prepare isolated PostgreSQL and SQL Server candidates; implement synthetic poison/replay workloads; gather metadata-only distributions when approved.

Batch gate: **Durable receipt/idempotency must pass before endpoint deletion after ACK. Database, capacity, retention, RPO/RTO, and broker decisions require measured evidence and human approval.**
