...
**Result path:** `batches/03-durability-release-identity/12-device-identity-network/result-12-device-identity-network.md`  
...
| I05 | `result-review-01-foundations.md` | `batch-01-review-result(3).md` | 135,455 bytes | `10d5e1e73fa7e63156ddc942c8f63156d29b7cff238ea7d4e128587b47f4c75b` | Accepted predecessor contracts, G1 boundary, policy safety, application/realm identity, repository, release, and Windows evidence gates. |

### 2.3.1 Allowlist conflict

**FACT.** The topic prompt says Prompts 09–14 must consume accepted Batch 1–2 decisions, but its explicit project-file allowlist permits Batch 01 and does not permit `result-review-02-endpoint-data.md`.
