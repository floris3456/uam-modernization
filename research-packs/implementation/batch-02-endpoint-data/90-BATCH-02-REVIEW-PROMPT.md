# Batch 02 reviewer — Endpoint source and privacy transformation
...
Save the complete response as `results/batch-02-endpoint-data/batch-02-review-result.md`.

## Attachments

Attach and read these result files completely:

- `results/batch-02-endpoint-data/07-g2-g3-edge-acquisition-cursor-result.md`
- `results/batch-02-endpoint-data/08-g4-url-privacy-transformation-result.md`
...
Implement and test G1; create synthetic Edge profiles and localhost fixtures; build a canary corpus; collect no real activity data.

Batch gate: **G1 must pass before integrating live source acquisition. G2/G3 and G4 must pass before any source value enters the production outbox.**
