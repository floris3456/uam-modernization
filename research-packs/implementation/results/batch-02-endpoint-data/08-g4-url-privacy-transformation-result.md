...
**Result path:** `results/batch-02-endpoint-data/08-g4-url-privacy-transformation-result.md`  
...
| I05 | `batch-01-review-result.md` (local export `batch-01-review-result(3).md`) | `10d5e1e73fa7e63156ddc942c8f63156d29b7cff238ea7d4e128587b47f4c75b` | accepted predecessor decisions for contracts, G1, application identity/matching, privacy lattice, repository, and test evidence |
...
| I05 | `batch-01-review-result.md`, review dated 31 July 2026; local export SHA-256 `10d5e1e73fa7e63156ddc942c8f63156d29b7cff238ea7d4e128587b47f4c75b` | accepted strict contracts, UUIDv7/application identity, G1 permit/Task Host boundary, finite privacy lattice, exact/suffix matcher, ambiguity, snapshots, repository/canary gates | conditional predecessor; many literal limits/dependencies and all production/human decisions remain gated |
