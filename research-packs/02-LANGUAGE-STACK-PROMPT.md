...
You are a staff engineer selecting a long-lived implementation stack for a Windows endpoint product and its server platform. Today is July 2026. Research current supported versions and roadmaps using primary sources. I attached `UAM-CODE-REFERENCE.md`; inspect the legacy agent, PSU app, and DDL to understand the real migration surface.
